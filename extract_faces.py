...
parser.add_argument('--trained_model', default='./weights/Resnet50_Final.pth',
...
if __name__ == '__main__':
    ...
    for filename in os.listdir(folder):
        ...
        if args.save_image:
            for b in dets:
                print(b[4])
                if b[4] < args.vis_thres or b[4]<first:
                    continue
                first = b[4]
                text = "{:.4f}".format(b[4])
                b = list(map(int, b))
               ...
               # cv2.putText(img_raw, text1, (cx, cy),
                ...
                if img_raw is not None:
                    try:
                        cv2.imwrite(imgpth,img_exp)
                    except Exception as e:
                        exception.append(imgpth)
                        pass
    ...
    print(exception)
        #if num%20 == 0:
        #    name = "/home/siddhartha/Siddhartha/Reveal-Media/Reveal Videos/frames-usual suspects/v" + "{:.4f}".format(num) + ".jpg"
        #    
