...
if __name__ == '__main__':
    ...
    num = 1
    # testing begin
    cam = cv2.VideoCapture('/home/siddhartha/Siddhartha/Reveal-Media/Reveal Videos/Redaction Med Test 22 Mar 2017.MP4')
    priorbox = PriorBox(cfg, image_size=(720, 720))
    ...
    while True:
        ...
        fps_str = "FPS: %.2f" % (1 / (time.time() - tic))
        # show image
        if args.save_image:
            for b in dets:
                ...
                img_exp = img_raw[b[1]:b[3], b[0]:b[2]]
                embs = get_embeds(img_exp).numpy()
                pred = get_pred(embs)
                pdt = "{:.4f}".format(pred[0])
                fps_str = "FPS: %.2f" % (1 / (time.time() - tic))
                text1 = pdt + text + fps_str
        ...
        name = "/home/siddhartha/Siddhartha/Reveal-Media/Reveal Videos/demo/v" + "{:.4f}".format(num) + ".jpg"
